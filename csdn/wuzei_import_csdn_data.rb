...
class DealFile
  @@tableName = "`crack_csdn`"
  @@tableNameStr = "crack_csdn"
...
#如果含有特殊字符取出来
    ...
    lineCatch = 0;
    ticks = 0;
    outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"begin insert csdn source id "+@@itemIdBegin.to_s + ", 1 tick means 100,000"))
    begin
      while line = inFile.gets
        ...
        if(i>100000)
          i=0
          ticks=ticks+1
          outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"next insert csdn source id "+@@itemIdBegin.to_s + ", 1 tick means 100,000"))
          outSqlFile.close
      ...
      outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"end insert csdn source id "+@@itemIdBegin.to_s + ", 1 tick means 100,000"))
...
#inFileName = "/home/allen/datas/www.csdn.net.sql"
#inFileName = "csdndata.enc.gbk.utf8"
