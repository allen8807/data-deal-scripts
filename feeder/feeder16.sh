...
curl -XPUT 'http://192.168.47.11:9201/wuzei_v1/_mapping/cnzz' -d '{
"cnzz": {
    "properties": {
        "email": {
            "type":     "string",
...
echo '
{
    ...
    "jdbc" : {
        ...
        "sql" :   "select concat(\"cnzz_\",id) as \"_id\", email as \"email\" , passwd as \"encrypt_pwd\" ,   18 as \"source\" ,  name as \"username\" from crack_cnzz",
