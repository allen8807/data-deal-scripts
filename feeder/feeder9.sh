...
curl -XPUT 'http://192.168.47.11:9201/wuzei_v1/_mapping/pconline' -d '{
"pconline": {
    "properties": {
        "email": {
            "type":     "string",
...
echo '
{
    ...
    "jdbc" : {
        ...
        "sql" :   "select concat(\"duduniu_\",id) as \"_id\", email as \"email\" ,plain_pwd as \"plain_pwd\" ,  9 as \"source\" ,  user_name as \"username\" from crack_pconline",
