...
#  inputParam2 = 1
#end
$inputParam = "all7k7k.txt.enc"
$inputParam2 = 16360439
...
class DealFile
  @@tableName = "`crack_7k7k`"
  @@tableNameStr = "crack_7k7k"
...
#如果含有特殊字符取出来
    ...
    lineCatch = 0;
    ticks = 0;
    outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"begin insert 7k7k source id "+@@itemIdBegin.to_s + ", 1 tick about 100,000"))
    begin
      while line = inFile.gets
        ...
        if(i>100000)
          ticks=ticks+1
          i=0
          outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"next insert 7k7k source id "+@@itemIdBegin.to_s + ", 1 tick about 100,000"))
          outSqlFile.close
      ...
      outSqlFile.puts(Log.commit(ticks,@@tableNameStr,"end insert 7k7k source id "+@@itemIdBegin.to_s + ", 1 tick about 100,000"))
...
inputFileName = inputFileName+".gb18030.utf8"
